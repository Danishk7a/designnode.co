...
export default function Header(){
   const [showToggle, setshowToggle] = useState(false)
    return (
      <header  className=" sticky w-full top-0 z-50 backdrop-blur-md  ">
       
          <div className="mx-auto flex justify-between max-w-7xl px-6 py-[13px] md:px-12 items-center">
                <Link href="/" className="text-white ml-10 ">
                    Design.
                </Link>

                <div className=" hidden gap-10 items-center">
                ...
                <svg onClick={(e)=>{setshowToggle((pre=>!pre))}} className={`transition-all duration-500 ease-in-out   cursor-pointer  mr-10 ${showToggle? 'rotate-90' :'rotate-0'} `} width="14" height="6" viewBox="0 0 14 6" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function MobileHeader({showToggle}){
    return(
<div
  className={`fixed top-[8vh] left-0 h-[100vh] p-4 flex flex-col gap-7 backdrop-blur-md z-[60]
